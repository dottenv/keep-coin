          ...
          <div className="mb-3 flex flex-col items-end gap-2.5">
            {ACTIONS.map((action, index) => (
              <button
                ...
                className="pressable flex items-center gap-2.5 rounded-full bg-white/85 py-2 pr-4 pl-2 text-sm font-semibold text-ink-800 shadow-lifted ring-1 ring-ink-100 backdrop-blur-xl animate-fade-in-up dark:bg-ink-900/80 dark:text-ink-100 dark:ring-white/10"
